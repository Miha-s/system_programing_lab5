...
#line 24 "calculator.y"
            { printf ("\t%.10g\n", yyvsp[-1]); }
#line 1199 "calculator.tab.c"
    break;

  case 6: /* line: error '\n'  */
#line 25 "calculator.y"
             { yyerrok; }
#line 1205 "calculator.tab.c"
    break;

  case 8: /* exp: exp '+' exp  */
#line 30 "calculator.y"
                     { yyval = yyvsp[-2] + yyvsp[0];      }
#line 1211 "calculator.tab.c"
    break;
