...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_arithmetic = 68,                /* arithmetic  */
...
{
       0,    87,    87,    94,    97,    98,    99,   100,   103,   104,
     104,   107,   120,   121,   122,   125,   125,   133,   133,   133,
     133,   138,   139,   140,   140,   141,   141,   144,   144,   145,
     148,   148,   182,   182,   224,   224,   225,   225,   236,   251,
     252,   255,   296,   299,   299,   300,   303,   304,   305,   306,
...
static const char *const yytname[] =
{
  ...
  "INCLUDE", "RETURN", "'('", "')'", "'{'", "'}'", "';'", "','", "'&'",
  "'='", "$accept", "program", "main", "datatype", "headers", "$@1",
  "condition", "body", "$@2", "$@3", "$@4", "$@5", "$@6", "$@7", "else",
  "$@8", "statement", "$@9", "$@10", "$@11", "$@12", "init", "expression",
  "return", "$@13", "relop", "arithmetic", "value", YY_NULLPTR
};
...
#line 87 "parser.y"
                                                  {
 	(yyvsp[-6].nd_obj).nd = createNode((yyvsp[-2].nd_obj).nd, (yyvsp[-1].nd_obj).nd, "main");
 	(yyval.nd_obj).nd = createNode((yyvsp[-7].nd_obj).nd, (yyvsp[-6].nd_obj).nd, "program");
...
#line 1421 "y.tab.c"
  ...
  case 8: /* headers: headers headers  */
#line 103 "parser.y"
                         { (yyval.nd_obj).nd = createNode((yyvsp[-1].nd_obj).nd, (yyvsp[0].nd_obj).nd, "headers"); }
#line 1427 "y.tab.c"
    break;
...
#line 1433 "y.tab.c"
  ...
  case 10: /* headers: INCLUDE $@1  */
#line 104 "parser.y"
                        { (yyval.nd_obj).nd = createNode(NULL, NULL, (yyvsp[-1].nd_obj).name); }
#line 1439 "y.tab.c"
    break;

  case 11: /* condition: value relop value  */
#line 107 "parser.y"
                             {
	(yyval.nd_obj3).nd = createNode((yyvsp[-2].nd_obj2).nd, (yyvsp[0].nd_obj2).nd, (yyvsp[-1].nd_obj).name);
	if(is_for) {
...
#line 1481 "y.tab.c"
  ...
  case 16: /* body: FOR $@2 '(' statement ';' condition ';' statement ')' '{' body '}'  */
#line 125 "parser.y"
                                                                                               {
	struct node *temp = createNode((yyvsp[-6].nd_obj3).nd, (yyvsp[-4].nd_obj).nd, "CONDITION");
	struct node *temp2 = createNode((yyvsp[-8].nd_obj).nd, temp, "CONDITION");
	(yyval.nd_obj).nd = createNode(temp2, (yyvsp[-1].nd_obj).nd, (yyvsp[-11].nd_obj).name);
...
#line 1512 "y.tab.c"
  ...
  case 20: /* body: IF $@3 '(' condition ')' $@4 '{' body '}' $@5 else  */
#line 133 "parser.y"
                                                                                                                                                                                       {
	struct node *iff = createNode((yyvsp[-7].nd_obj3).nd, (yyvsp[-3].nd_obj).nd, (yyvsp[-10].nd_obj).name);
	(yyval.nd_obj).nd = createNode(iff, (yyvsp[0].nd_obj).nd, "if-else");
	sprintf(icg[ic_idx++], "GOTO next\n");
}
#line 1522 "y.tab.c"
    break;

  case 21: /* body: statement ';'  */
#line 138 "parser.y"
                { (yyval.nd_obj).nd = (yyvsp[-1].nd_obj).nd; }
#line 1528 "y.tab.c"
    break;

  case 22: /* body: body body  */
#line 139 "parser.y"
            { (yyval.nd_obj).nd = createNode((yyvsp[-1].nd_obj).nd, (yyvsp[0].nd_obj).nd, "statements"); }
#line 1534 "y.tab.c"
    break;
...
#line 1564 "y.tab.c"
  ...
  case 28: /* else: ELSE $@8 '{' body '}'  */
#line 144 "parser.y"
                                      { (yyval.nd_obj).nd = createNode(NULL, (yyvsp[-1].nd_obj).nd, (yyvsp[-4].nd_obj).name); }
#line 1570 "y.tab.c"
    break;
...
#line 148 "parser.y"
                                          {
	(yyvsp[-2].nd_obj).nd = createNode(NULL, NULL, (yyvsp[-2].nd_obj).name);
	int t = checkTypes((yyvsp[-3].nd_obj).name, (yyvsp[0].nd_obj2).type);
	if(t>0) {
		if(t == 1) {
			struct node *temp = createNode(NULL, (yyvsp[0].nd_obj2).nd, "floattoint");
			(yyval.nd_obj).nd = createNode((yyvsp[-2].nd_obj).nd, temp, "declaration");
		}
		else if(t == 2) {
			struct node *temp = createNode(NULL, (yyvsp[0].nd_obj2).nd, "inttofloat");
			(yyval.nd_obj).nd = createNode((yyvsp[-2].nd_obj).nd, temp, "declaration");
		}
		else if(t == 3) {
			struct node *temp = createNode(NULL, (yyvsp[0].nd_obj2).nd, "chartoint");
			(yyval.nd_obj).nd = createNode((yyvsp[-2].nd_obj).nd, temp, "declaration");
		}
		else if(t == 4) {
			struct node *temp = createNode(NULL, (yyvsp[0].nd_obj2).nd, "inttochar");
			(yyval.nd_obj).nd = createNode((yyvsp[-2].nd_obj).nd, temp, "declaration");
		}
		else if(t == 5) {
			struct node *temp = createNode(NULL, (yyvsp[0].nd_obj2).nd, "chartofloat");
			(yyval.nd_obj).nd = createNode((yyvsp[-2].nd_obj).nd, temp, "declaration");
		}
		else{
			struct node *temp = createNode(NULL, (yyvsp[0].nd_obj2).nd, "floattochar");
			(yyval.nd_obj).nd = createNode((yyvsp[-2].nd_obj).nd, temp, "declaration");
		}
	}
	else {
		(yyval.nd_obj).nd = createNode((yyvsp[-2].nd_obj).nd, (yyvsp[0].nd_obj2).nd, "declaration");
	}
...
#line 1621 "y.tab.c"
  ...
  case 32: /* $@10: %empty  */
#line 182 "parser.y"
     { checkDeclaration((yyvsp[0].nd_obj).name); }
#line 1627 "y.tab.c"
    break;
...
#line 182 "parser.y"
                                                   {
	(yyvsp[-3].nd_obj).nd = createNode(NULL, NULL, (yyvsp[-3].nd_obj).name);
	char *id_type = getType((yyvsp[-3].nd_obj).name);
	if(strcmp(id_type, (yyvsp[0].nd_obj2).type)) {
		if(!strcmp(id_type, "int")) {
			if(!strcmp((yyvsp[0].nd_obj2).type, "float")){
				struct node *temp = createNode(NULL, (yyvsp[0].nd_obj2).nd, "floattoint");
				(yyval.nd_obj).nd = createNode((yyvsp[-3].nd_obj).nd, temp, "=");
			}
			else{
				struct node *temp = createNode(NULL, (yyvsp[0].nd_obj2).nd, "chartoint");
				(yyval.nd_obj).nd = createNode((yyvsp[-3].nd_obj).nd, temp, "=");
		...
		(yyval.nd_obj).nd = createNode((yyvsp[-3].nd_obj).nd, (yyvsp[0].nd_obj2).nd, "=");
	}
...
#line 224 "parser.y"
                                                     { (yyvsp[-3].nd_obj).nd = createNode(NULL, NULL, (yyvsp[-3].nd_obj).name); (yyval.nd_obj).nd = createNode((yyvsp[-3].nd_obj).nd, (yyvsp[0].nd_obj2).nd, (yyvsp[-1].nd_obj).name); }
#line 1686 "y.tab.c"
    break;
...
#line 225 "parser.y"
                                          {
	(yyvsp[-2].nd_obj).nd = createNode(NULL, NULL, (yyvsp[-2].nd_obj).name);
	(yyvsp[0].nd_obj).nd = createNode(NULL, NULL, (yyvsp[0].nd_obj).name);
	(yyval.nd_obj).nd = createNode((yyvsp[-2].nd_obj).nd, (yyvsp[0].nd_obj).nd, "ITERATOR");
...
#line 236 "parser.y"
           {
	checkDeclaration((yyvsp[0].nd_obj).name);
	(yyvsp[-1].nd_obj).nd = createNode(NULL, NULL, (yyvsp[-1].nd_obj).name);
	(yyvsp[0].nd_obj).nd = createNode(NULL, NULL, (yyvsp[0].nd_obj).name);
	(yyval.nd_obj).nd = createNode((yyvsp[-1].nd_obj).nd, (yyvsp[0].nd_obj).nd, "ITERATOR");
...
#line 255 "parser.y"
	...
	if(!strcmp((yyvsp[-2].nd_obj2).type, (yyvsp[0].nd_obj2).type)) {
		...
		(yyval.nd_obj2).nd = createNode((yyvsp[-2].nd_obj2).nd, (yyvsp[0].nd_obj2).nd, (yyvsp[-1].nd_obj).name);
	}
	else {
		if(!strcmp((yyvsp[-2].nd_obj2).type, "int") && !strcmp((yyvsp[0].nd_obj2).type, "float")) {
			struct node *temp = createNode(NULL, (yyvsp[-2].nd_obj2).nd, "inttofloat");
			sprintf((yyval.nd_obj2).type, (yyvsp[0].nd_obj2).type);
			(yyval.nd_obj2).nd = createNode(temp, (yyvsp[0].nd_obj2).nd, (yyvsp[-1].nd_obj).name);
		}
		else if(!strcmp((yyvsp[-2].nd_obj2).type, "float") && !strcmp((yyvsp[0].nd_obj2).type, "int")) {
			struct node *temp = createNode(NULL, (yyvsp[0].nd_obj2).nd, "inttofloat");
			sprintf((yyval.nd_obj2).type, (yyvsp[-2].nd_obj2).type);
			(yyval.nd_obj2).nd = createNode((yyvsp[-2].nd_obj2).nd, temp, (yyvsp[-1].nd_obj).name);
		}
			...
			struct node *temp = createNode(NULL, (yyvsp[-2].nd_obj2).nd, "chartoint");
			sprintf((yyval.nd_obj2).type, (yyvsp[0].nd_obj2).type);
			(yyval.nd_obj2).nd = createNode(temp, (yyvsp[0].nd_obj2).nd, (yyvsp[-1].nd_obj).name);
		}
			...
			struct node *temp = createNode(NULL, (yyvsp[-2].nd_obj2).nd, "chartofloat");
			sprintf((yyval.nd_obj2).type, (yyvsp[0].nd_obj2).type);
			(yyval.nd_obj2).nd = createNode(temp, (yyvsp[0].nd_obj2).nd, (yyvsp[-1].nd_obj).name);
		}
	}
...
#line 1796 "y.tab.c"
  ...
  case 44: /* return: RETURN $@13 value ';'  */
#line 299 "parser.y"
                                       { checkReturnType((yyvsp[-1].nd_obj2).name); (yyvsp[-3].nd_obj).nd = createNode(NULL, NULL, "return"); (yyval.nd_obj).nd = createNode((yyvsp[-3].nd_obj).nd, (yyvsp[-1].nd_obj2).nd, "RETURN"); }
#line 1802 "y.tab.c"
    break;
...
#line 317 "parser.y"
              { strcpy((yyval.nd_obj2).name, (yyvsp[0].nd_obj).name); sprintf((yyval.nd_obj2).type, "int"); add('C'); (yyval.nd_obj2).nd = createNode(NULL, NULL, (yyvsp[0].nd_obj).name); }
#line 1814 "y.tab.c"
    break;

  case 57: /* value: FLOAT_NUM  */
#line 318 "parser.y"
            { strcpy((yyval.nd_obj2).name, (yyvsp[0].nd_obj).name); sprintf((yyval.nd_obj2).type, "float"); add('C'); (yyval.nd_obj2).nd = createNode(NULL, NULL, (yyvsp[0].nd_obj).name); }
#line 1820 "y.tab.c"
    break;

  case 58: /* value: CHARACTER  */
#line 319 "parser.y"
            { strcpy((yyval.nd_obj2).name, (yyvsp[0].nd_obj).name); sprintf((yyval.nd_obj2).type, "char"); add('C'); (yyval.nd_obj2).nd = createNode(NULL, NULL, (yyvsp[0].nd_obj).name); }
#line 1826 "y.tab.c"
    break;

  case 59: /* value: ID  */
#line 320 "parser.y"
     { strcpy((yyval.nd_obj2).name, (yyvsp[0].nd_obj).name); char *id_type = getType((yyvsp[0].nd_obj).name); sprintf((yyval.nd_obj2).type, id_type); checkDeclaration((yyvsp[0].nd_obj).name); (yyval.nd_obj2).nd = createNode(NULL, NULL, (yyvsp[0].nd_obj).name); }
#line 1832 "y.tab.c"
    break;
